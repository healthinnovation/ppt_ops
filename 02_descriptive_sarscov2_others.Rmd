...
labeller(
  distance_to_rh_hf_sampl = c(
    Chik.E1_pos = "Chikungunya",
    Dengue.NS1.1_pos = "Dengue - Type 1",
    Dengue.NS1.2_pos = "Dengue - Type 2",
    Dengue.NS1.3_pos = "Dengue - Type 3",
    Dengue.NS1.4_pos = "Dengue - Type 4",
    H3N2_pos = "Influenza",
    HKV1.NP_pos = "Common Cold 1",
    MERSP.NP_pos = "MERS",
    OC43.NP_pos = "Common Cold 2",
    SARS.NP.WT_pos = "COVID-19",
    SEA_pos = "Schistosomiasis",
    Tet.Tox_pos = "Tetanus toxoid",
    X229.E.NP_pos = "Human coronavirus - 229E",
    Zika.NS1_pos = "Zika"
  )
)
